...
function fetchCryptoData(cryptoId) {
    ...
    return __awaiter(this, void 0, void 0, function () {
        var response, apiKey, ex_1;
        return __generator(this, function (_b) {
            switch (_b.label) {
                case 0:
                    response = null;
                    apiKey = (_a = process.env.COIN_MARKETCAP_API_KEY) !== null && _a !== void 0 ? _a : "";
                    _b.label = 1;
                case 1:
                    _b.trys.push([1, 3, , 4]);
                    return [4 /*yield*/, axios_1.default.get('https://pro-api.coinmarketcap.com/v2/cryptocurrency/info', {
                            headers: {
